...
Please insert a directory to generate recipes from...";
        ...
        public const string SHOULD_USE_THREADING =
@"Enable multi-threading? (y = yes, anything else = no)";
...
@"Program does not have write access in its current directory.
Please restart it in admin mode, or move to an unprotected directory.";

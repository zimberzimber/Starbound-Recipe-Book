...
namespace SRBG
{
	static class Unlocks
	{
		...
		public static void WriteToFile()
		{
			...
			using (StreamWriter file = new StreamWriter(string.Format("{0}{1}{2}", AppDomain.CurrentDomain.BaseDirectory, Strings.OUTPUT_DIRECTORY_NAME, Strings.UNLOCKS_DICTIONARY_FILE_NAME)))
			{
